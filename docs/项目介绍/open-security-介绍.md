# [开源]OpenSecurity：AI 驱动的多领域安全分析 Agent 平台
...
这个平台的核心价值在于**知识蒸馏**——把安全研究员在实战中积累的隐性经验（脱壳套路、算法识别技巧、漏洞利用模式），提炼成可复用的脚本和知识库文档。你贡献的每一次分析经验，都会被蒸馏成所有人共享的资产，让平台越用越强。

- 想贡献代码或文档？看 [CONTRIBUTING.md](https://github.com/zylc369/OpenSecurity/blob/main/CONTRIBUTING.md)
- 想找任务认领？看 [Roadmap](https://github.com/zylc369/OpenSecurity/blob/main/docs/ROADMAP.md) 的 v1.0 方向，或浏览 [Issues](https://github.com/zylc369/OpenSecurity/issues)
- 有想法想讨论？去 [Discussions](https://github.com/zylc369/OpenSecurity/discussions) 开帖
- 发现了 bug？[提 Issue](https://github.com/zylc369/OpenSecurity/issues/new/choose)，选 Bug 报告模板
...
**项目地址**：[https://github.com/zylc369/OpenSecurity](https://github.com/zylc369/OpenSecurity)
